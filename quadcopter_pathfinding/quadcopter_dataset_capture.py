...
stop_dir = "C:/Users/ASUS/Documents/Code/CoppeliaSims_py/quadcopter_path_finding/train_data/stop"
os.makedirs(right_dir, exist_ok=True)
...
try:
    while True:
        ...
        if com == ord('q'):
            ...
            down_ct += 1
        # elif com == ord('b'):
        #     filename = os.path.join(stop_dir, f"stop_{stop_ct}.jpg")
        #     cv2.imwrite(filename, cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
        #     stop_ct += 1
